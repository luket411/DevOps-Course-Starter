...
def test_add_items_makes_correct_request(monkeypatch):
    ...
    monkeypatch.setattr(todo_app.data.trello_interface, "post", mock_post_response)
    monkeypatch.setattr(todo_app.data.trello_interface, "update_from_trello", mock.MagicMock(return_value=loads(base_json_response)))
...
def test_update_from_trello_makes_correct_request(monkeypatch):
    ...
    monkeypatch.setattr(todo_app.data.trello_interface, "get", mock_get_response)
